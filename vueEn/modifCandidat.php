        ...
        <table class="tableCandidat" align="center">
            ...
            while ($row = $req->fetch()) : ?>
                <tr>
                    ...
                    <td><a id="modif" class="bouton" href="?lan=en&action=modifierUser&id=<?= $row['id'] ?>">Edit<br></a>
                        <a id="sup" class="bouton" href="?lan=en&action=suppUser&id=<?= $row['id'] ?>" onclick=" return confirm('Are you sure you want to delete this profile ?');">Delete</a>
                    </td>
                </tr>
                <br>
            <?php endwhile ?>
